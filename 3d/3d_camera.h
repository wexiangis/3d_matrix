...
typedef struct _3DCamera
{
    ...
    double openAngle; //相机视野开角,单位:rad,范围(0,PI)
 ...
 *  返回: NULL/参数错误
 */
_3D_Camera *_3d_camera_init(uint32_t width, uint32_t height, double openAngle, uint32_t near, uint32_t far);
// 相机重置
...
void _3d_camera_roll(_3D_Camera *camera, double *rXYZ);
// 相机3轴平移, 增量式, 基于空间坐标系
void _3d_camera_mov(_3D_Camera *camera, double *mXYZ);
// 相机3轴平移, 增量式, 基于自身坐标系
void _3d_camera_mov2(_3D_Camera *camera, double *mXYZ);
